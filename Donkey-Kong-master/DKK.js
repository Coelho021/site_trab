...
var saltando = false;
var salto = 18;
var ganaste = crearTM("Win") 
var gravedad = 2;
var bucle;
var puntos = 0;
var perdiste = crearTM("GAMER OVER");
var ju1 = crearTMIP("Coloque o seu nome");
var reglas = crearTM("Sobreviva até o final");
var vidas = 3;
var nivel = 0;
var ju;
var boom = 2;
...
class Informacion {
	...
	dibujar() {
		ctx.fillStyle = 'black';
		ctx.font = "18px Arial";
		ctx.fillText("jogador: "+ju, 10, 15);
		ctx.fillText("Pontuação: "+puntos, 320, 15);
